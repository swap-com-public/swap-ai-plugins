# POST /tax-duty/v1/process

**Resource:** [Process TLC](../resources/Process-TLC.md)
**Compute TLC for a cross-border shipment**
**Operation ID:** `TLCController_createTransaction`
...
**Schema:** [TLCRequest](../schemas/TLCRequest/TLCRequest.md)
...
|-------|------|----------|-------------|
| `message` | string | Yes |  |
| `data` | [TLCResponse](../schemas/TLCResponse/TLCResponse.md) | Yes |  |
