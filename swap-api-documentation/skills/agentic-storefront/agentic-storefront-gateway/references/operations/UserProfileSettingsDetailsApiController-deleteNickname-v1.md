# DELETE /v1/user/profile-settings/nickname

**Resource:** [UserProfileSettingsDetailsApi](../resources/UserProfileSettingsDetailsApi.md)
**Delete user nickname**
**Operation ID:** `UserProfileSettingsDetailsApiController_deleteNickname_v1`

Deletes the user nickname (requires authenticated user)
...
| Status | Description |
|--------|-------------|
| 200 | Successfully deleted nickname |
