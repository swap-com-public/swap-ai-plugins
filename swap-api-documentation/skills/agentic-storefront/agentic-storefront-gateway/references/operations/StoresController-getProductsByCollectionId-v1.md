# GET /v1/api/stores/collections/{collectionId}

**Resource:** [Stores](../resources/Stores.md)
**List products inside a collection**
**Operation ID:** `StoresController_getProductsByCollectionId_v1`
...
| `limit` | query | integer | No | Defaults to 8 in StoresController. |
