# GET /v1/api/stores/current

**Resource:** [Stores](../resources/Stores.md)
**Resolve the active store from the request host**
**Operation ID:** `StoresController_getCurrentStore_v1`

## Responses

| Status | Description |
|--------|-------------|
| 200 | Custom domain: store data. Base domain: success with data null. |
