# DELETE /v1/user/profile-settings/saved-addresses/{addressId}

**Resource:** [UserProfileSettingsDetailsApi](../resources/UserProfileSettingsDetailsApi.md)
**Delete saved address**
**Operation ID:** `UserProfileSettingsDetailsApiController_deleteSavedAddress_v1`

Removes the saved address from the user profile
...
| Status | Description |
|--------|-------------|
| 200 | Successfully deleted saved address |
