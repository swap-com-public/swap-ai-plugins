# POST /v1/agents/nickname/validate

**Resource:** [NicknameJudge](../resources/NicknameJudge.md)
**Check whether a nickname is allowed before saving**
**Operation ID:** `NicknameJudgeController_validateNickname_v1`
...
**Schema:** [ValidateNicknameDto](../schemas/Validate/ValidateNicknameDto.md)

## Responses

| Status | Description |
|--------|-------------|
| 200 | Nickname validation completed. |
...
|-------|------|----------|-------------|
| `messages` | string[] | Yes |  |
| `data` | [NicknameVerdict](../schemas/Nickname/NicknameVerdict.md) | Yes |  |
